...
__all__ = [ "TestRecursivizer", "suite", "main" ];
...
from pypes.scoping.recursivizer import recursivize;
...
class TestRecursivizer( TestCase, metaclass=object_ ):
    ...
    try:
      ...
      try:
        ...
        try:
          ...
          g = open( filename.replace( ".pft.gz", "-rec.pft" ), "w" );
          try:
            ...
            try:
              ...
              pf2 = recursivize( pf1 );
              pstr = pft_encode( pf2, pretty=False );
              print( pstr );
              g.write( pstr );
              g.write( "\n" );
              print( "-------" );
