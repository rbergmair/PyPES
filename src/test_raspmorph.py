...
testcases = [
    "The_AT", "cat_NN1", "chased_VVD", "chased_VVN", "the_AT", "dog_NN1",
    "dog_VV0", "I_MC", "saw_NN1", "saw_VVD", "a_AT1", "man_NN1", "with_IW",
    "telescope_NN1", "telescope_VV0"
  ];
...
"""<smaf>
  <lattice init="v0" final="v35" cfrom="0" cto="207">
