...
# small adaptations by Richard Bergmair, marked by rb432
# automatic conversion to Python 3.0 by "2to3" tool

#   http://nltk.googlecode.com/svn/trunk/nltk/nltk/tokenize/punkt.py
# downloaded DEC-15, 2009: r8355 by joel.nothman on Sep 21, 2009
...
class PunktSentenceTokenizer(_PunktBaseClass,TokenizerI):
    ...
    def train(self, train_text, verbose=False):
        ...
        """
        if type(train_text) not in (type(''), type('')):
            return train_text
